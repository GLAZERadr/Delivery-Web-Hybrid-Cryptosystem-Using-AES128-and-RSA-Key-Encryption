...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <li class="nav-item">
                <a class="nav-link text-center" href="<?= base_url('kurir') ?>">
                    <span>Delivery</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('kurir/pengirimandaftar') ?>">
                    <i class="fas fa-fw fa-list"></i>
                    <span>Data Pengiriman</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('kurir/historypengiriman') ?>">
                    <i class="fas fa-fw fa-list"></i>
                    <span>History Pengiriman</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('kurir/profil') ?>">
